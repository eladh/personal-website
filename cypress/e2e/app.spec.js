...
describe('App', () => {
  ...
  it('should toggle darkmode', () => {
    cy.findByLabelText('toggle theme')
      .click()
      .should(() => {
        expect(localStorage.getItem('eladh-theme')).to.eq('dark');
      })
      .click()
      .should(() => {
        expect(localStorage.getItem('eladh-theme')).to.eq('light');
      });
  });
  ...
  it('should navigate to blog', () => {
    const editGithubUrl = `https://github.com/eladh/personal-website/tree/develop/content/blog/exciting-new-features-in-javascript/index.md`;
